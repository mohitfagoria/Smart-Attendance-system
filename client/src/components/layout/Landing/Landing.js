...
import "../../../App.css";
import logo from "./iiita_logo.png";
        ...
        <footer>
          <div className="row justify-content-center">
            <div className="col-md-5 text-center">
              ...
              <br />
              <p>
              IIIT Rd, IIIT, Jhalwa, Prayagraj, Saha Urf Pipalgaon, Uttar Pradesh 211012
                <br />
                <i className="fas fa-phone "></i> +91-761-263227 |{" "}
                <i className="fas fa-print"></i> +91-761-263252.
                <br />
